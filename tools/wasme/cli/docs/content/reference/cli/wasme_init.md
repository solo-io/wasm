...
```
  ...
  -h, --help                      help for init
      ...
      --platform-version string   The version of the target platform against which to build. Supported Istio versions are: [1.5.x 1.6.x 1.7.x 1.8.x 1.9.x 1.10.x 1.11.x]. Supported Gloo versions are: [1.3.x 1.5.x 1.6.x]
```

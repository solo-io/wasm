...
`,
	...
	cmd.PersistentFlags().StringVar(&opts.platform.Version, "platform-version", "",
		fmt.Sprintf("The version of the target platform against which to build. Supported Istio versions are: %v. Supported Gloo versions are: %v", []string{abi.Version15x, abi.Version16x, abi.Version17x, abi.Version18x, abi.Version19x, abi.Version110x, abi.Version111x}, []string{abi.Version13x, abi.Version15x, abi.Version16x}))
